...
export const EXTINGUISHER_CATALOG: CommercialExtinguisherItem[] = [
  ...
  },
  {
    ...
    type: 'PQS_ABC',
    capacity: '10kg',
    name: 'Extintor de Polvo Químico Seco (PQS ABC) 10 kg',
    agent: 'Fosfato Monoamónico 75%',
    fireClasses: 'A, B, C',
    unitCost: 1800.0,
    normative: 'NOM-100-STPS-1994 / NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'CO2',
    capacity: '10kg',
    name: 'Extintor de Dióxido de Carbono (CO2) 10 kg',
    agent: 'CO2 Gas Inerte Dieléctrico',
    fireClasses: 'B, C',
    unitCost: 7500.0,
    normative: 'NOM-102-STPS-1994 / NOM-016-SSA3-2012',
  ...
  },
  {
    ...
    type: 'CLEAN_AGENT',
    capacity: '4.5kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 4.5 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 13500.0,
    normative: 'NOM-104-STPS-2001 / NOM-016-SSA3-2012',
  ...
  },
  {
    ...
    type: 'CLEAN_AGENT',
    capacity: '10kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 10 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 19500.0,
    normative: 'NOM-104-STPS-2001 / NOM-016-SSA3-2012',
  ...
  // Agua a Presión - A
  {
    ...
    capacity: '6L',
    name: 'Extintor de Agua Presurizada 6 L',
  ...
  },
  {
    ...
    type: 'WATER_PRESSURIZED',
    capacity: '9.5L',
    name: 'Extintor de Agua Presurizada 9.5 L',
    agent: 'Agua Desmineralizada con Presión',
    fireClasses: 'A',
    unitCost: 2000.0,
    normative: 'NOM-103-STPS-1994',
  ...
  // AFFF (Espuma Mecánica) - A, B
  {
    ...
    type: 'PQS_ABC',
    capacity: '4.5kg',
    name: 'Extintor de Espuma Mecánica AFFF 4.5 kg',
  ...
  },
  {
    ...
    type: 'PQS_ABC',
    capacity: '6L',
    name: 'Extintor de Espuma Mecánica AFFF 6 L',
    agent: 'Espuma Mecánica AFFF',
    fireClasses: 'A, B',
    unitCost: 2500.0,
    normative: 'NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'PQS_ABC',
    capacity: '9.0L',
    name: 'Extintor de Espuma Mecánica AFFF 9 L',
    agent: 'Espuma Mecánica AFFF',
    fireClasses: 'A, B',
    unitCost: 3500.0,
    normative: 'NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'CLASS_K',
    capacity: '9.0L',
    name: 'Extintor Clase K Acetato de Potasio 9.0 Litros',
    agent: 'Solución Acuosa Acetato de Potasio',
    fireClasses: 'K',
    unitCost: 7000.0,
    normative: 'NOM-002-STPS-2010 / NFPA 10',
