...
export const EXTINGUISHER_CATALOG: CommercialExtinguisherItem[] = [
  // PQS (Polvo Químico Seco) - A, B, C
  {
    sku: 'EXT-PQS-2.5KG',
    type: 'PQS_ABC',
    capacity: '2.5kg',
    name: 'Extintor de Polvo Químico Seco (PQS ABC) 2.5 kg',
  ...
  },
  {
    ...
    type: 'PQS_ABC',
    capacity: '4.5kg',
    name: 'Extintor de Polvo Químico Seco (PQS ABC) 4.5 kg',
    agent: 'Fosfato Monoamónico 75%',
    fireClasses: 'A, B, C',
    unitCost: 1100.0,
    normative: 'NOM-100-STPS-1994 / NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'PQS_ABC',
    capacity: '10.0kg',
    name: 'Extintor de Polvo Químico Seco (PQS ABC) 10.0 kg',
    agent: 'Fosfato Monoamónico 75%',
    fireClasses: 'A, B, C',
    unitCost: 1800.0,
    normative: 'NOM-100-STPS-1994 / NOM-002-STPS-2010',
  ...
  // CO₂ (Dióxido de Carbono) - B, C
  {
    sku: 'EXT-CO2-2.5KG',
    type: 'CO2',
    capacity: '2.5kg',
    name: 'Extintor de Dióxido de Carbono (CO2) 2.5 kg',
  ...
  },
  {
    ...
    type: 'CO2',
    capacity: '4.5kg',
    name: 'Extintor de Dióxido de Carbono (CO2) 4.5 kg',
    agent: 'CO2 Gas Inerte Dieléctrico',
    fireClasses: 'B, C',
    unitCost: 4000.0,
    normative: 'NOM-102-STPS-1994 / NOM-016-SSA3-2012',
  ...
  },
  {
    ...
    type: 'CO2',
    capacity: '6.0kg',
    name: 'Extintor de Dióxido de Carbono (CO2) 6.0 kg',
    agent: 'CO2 Gas Inerte Dieléctrico',
    fireClasses: 'B, C',
    unitCost: 5200.0,
    normative: 'NOM-102-STPS-1994 / NOM-016-SSA3-2012',
  ...
  },
  {
    ...
    type: 'CO2',
    capacity: '10.0kg',
    name: 'Extintor de Dióxido de Carbono (CO2) 10.0 kg',
    agent: 'CO2 Gas Inerte Dieléctrico',
    fireClasses: 'B, C',
    unitCost: 7500.0,
    normative: 'NOM-102-STPS-1994 / NOM-016-SSA3-2012',
  ...
  // Halotrón (Agente Limpio / HFC) - A, B, C
  {
    sku: 'EXT-CLEAN-2.5KG',
    type: 'CLEAN_AGENT',
    capacity: '2.5kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 2.5 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 11500.0,
  ...
  },
  {
    ...
    type: 'CLEAN_AGENT',
    capacity: '4.6kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 4.6 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 13500.0,
    normative: 'NOM-104-STPS-2001 / NOM-016-SSA3-2012',
  ...
  },
  {
    ...
    type: 'CLEAN_AGENT',
    capacity: '6.0kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 6.0 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 16500.0,
    normative: 'NOM-104-STPS-2001 / NOM-016-SSA3-2012',
  ...
  {
    sku: 'EXT-CLEAN-10.0KG',
    type: 'CLEAN_AGENT',
    capacity: '10.0kg',
    name: 'Extintor Agente Limpio HFC (Halotrón) 10.0 kg',
    agent: 'HFC Agente Limpio no corrosivo',
    fireClasses: 'A, B, C',
    unitCost: 19500.0,
    normative: 'NOM-104-STPS-2001 / NOM-016-SSA3-2012',
  ...
  // Agua a Presión - A
  {
    sku: 'EXT-CLASEA-6.0KG',
    type: 'WATER_PRESSURIZED',
    capacity: '6.0kg',
    name: 'Extintor de Agua a Presión — Clase A 6kg',
  ...
  {
    sku: 'EXT-CLASEA-10.0KG',
    type: 'WATER_PRESSURIZED',
    capacity: '10.0kg',
    name: 'Extintor de Agua a Presión — Clase A 10kg',
    agent: 'Agua Desmineralizada con Presión',
    fireClasses: 'A',
    unitCost: 2000.0,
    normative: 'NOM-103-STPS-1994',
  ...
  // AFFF (Espuma Mecánica) - A, B
  {
    sku: 'EXT-AFFF-4.5KG',
    type: 'AFFF',
    capacity: '4.5kg',
    name: 'Extintor de espuma AFFF Espuma clase A, B 4.5kg',
    agent: 'Espuma Mecánica AFFF',
    fireClasses: 'A, B',
    unitCost: 2000.0,
    normative: 'NOM-002-STPS-2010',
    includesWallBracket: true,
  },
  {
    sku: 'EXT-AFFF-6.0KG',
    type: 'AFFF',
    capacity: '6.0kg',
    name: 'Extintor de espuma AFFF Espuma clase A, B 6.0kg',
    agent: 'Espuma Mecánica AFFF',
    fireClasses: 'A, B',
    unitCost: 2500.0,
    normative: 'NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'AFFF',
    capacity: '10.0kg',
    name: 'Extintor de espuma AFFF Espuma clase A, B 10.0kg',
    agent: 'Espuma Mecánica AFFF',
    fireClasses: 'A, B',
    unitCost: 3500.0,
    normative: 'NOM-002-STPS-2010',
  ...
  },
  {
    ...
    type: 'CLASS_K',
    capacity: '10L',
    name: 'Extintor Clase K Acetato de Potasio 10.0 Litros',
    agent: 'Solución Acuosa Acetato de Potasio',
    fireClasses: 'K',
    unitCost: 7000.0,
    normative: 'NOM-002-STPS-2010 / NFPA 10',
